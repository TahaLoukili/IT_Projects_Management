                ...
                <div class="px-4 py-5 sm:px-6">
                    ...
                    <div>
	                    <%-- <div><a href="editProject?id=<c:out value='${project.getId()}' />" class="font-medium text-indigo-600 hover:text-indigo-500">Edit</a></div> --%>
		                    <div class="flex">
  <a href="editProject?id=<%= project.getId() %>" name="editProject" class="flex-1 font-medium bg-indigo-600 rounded-md text-white hover:bg-indigo-500 px-4 py-2 inline-block text-center mr-2">Edit</a>
  <a href="deleteProject?id=<%= project.getId() %>" name="deleteProject" class="flex-1 font-medium bg-red-600 rounded-md text-white hover:bg-red-500 px-4 py-2 inline-block text-center" onclick="confirmDelete(event)">Delete</a>
</div>
