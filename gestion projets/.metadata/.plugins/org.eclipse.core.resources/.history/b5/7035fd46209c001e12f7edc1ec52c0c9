      ...
      <% if(user != null && user.getRole() == 1){ %>
        ...
        <li>
          <a href="ajouterMethodologie" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-cyan-500 text-gray-600 hover:text-gray-800 border-l-4 border-transparent">
            ...
            <span class="ml-2 text-sm text-white tracking-wide truncate">Ajouter Methodologie</span>
          </a>
        </li>
        <%} %>
        <li>
          <a href="ajouterTechnologie" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-cyan-500 text-gray-600 hover:text-gray-800 border-l-4 border-transparent">
            ...
            <span class="ml-2 text-sm text-white tracking-wide truncate">Ajouter Technologie</span>
          </a>
        </li>
        <li>
          <a href="disconnect" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-cyan-500 text-gray-600 hover:text-gray-800 border-l-4 border-transparent">
            <!-- Icono Sign Out de Font Awesome -->
            <span class="inline-flex justify-center items-center ml-4">
              <i class="fas fa-sign-out-alt"></i>
            </span>
            <span class="ml-2 text-sm text-white tracking-wide truncate">Log out</span>
          </a>
        </li>
      </ul>
